...
def get_match(imagePath,category_name):
    ...
    while i<len(LIST):
        ...
        img_resize2 = cv2.resize(img2, (256, 256))
    ...
    cursor.execute("select picture ,price,shopOwnerID ,productID from product where categoryID="+ID)
...
#print(c)
  ...
  #return jsonify( {"name": list_images})
